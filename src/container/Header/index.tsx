...
const Header = () => {
  ...
  const imageWays = ['/images/react.png', '/images/node.png', '/images/sass.png']
  ...
  return (
    <div className='app__header app__flex'>
      ...
      <motion.div whileInView={{opacity: [0, 1] }} transition={{ duration: 0.5, delayChildren: 0.5 }} className="app__header-img">
        <img src="/images/profile.png" alt="profile_bg" />
        <motion.img whileInView={{scale: [0, 1] }} transition={{ duration: 1, ease: 'easeInOut' }} className="overlay_circle" src="/images/circle.svg" alt='profile_circle'/>
      </motion.div>

      <motion.div variants={scaleVariants} whileInView={scaleVariants.whileInView} className="app__header-circles">
        {imageWays.map((circle, index) => (
